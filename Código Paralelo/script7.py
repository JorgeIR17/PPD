...
#python3 script7.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd7 = "/tmp/pipe_wd7"
    pipe_rd7 = "/tmp/pipe_rd7"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd7):
        os.mkfifo(pipe_wd7)
    if not os.path.exists(pipe_rd7):
        os.mkfifo(pipe_rd7)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd7, "r") as pipe_in:
                ...
                with open(pipe_rd7, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd7):
            os.unlink(pipe_wd7)
        if os.path.exists(pipe_rd7):
            os.unlink(pipe_rd7)