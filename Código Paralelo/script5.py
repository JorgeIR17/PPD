...
#python3 script5.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd5 = "/tmp/pipe_wd5"
    pipe_rd5 = "/tmp/pipe_rd5"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd5):
        os.mkfifo(pipe_wd5)
    if not os.path.exists(pipe_rd5):
        os.mkfifo(pipe_rd5)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd5, "r") as pipe_in:
                ...
                with open(pipe_rd5, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd5):
            os.unlink(pipe_wd5)
        if os.path.exists(pipe_rd5):
            os.unlink(pipe_rd5)