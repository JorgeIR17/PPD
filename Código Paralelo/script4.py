...
#python3 script4.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd4 = "/tmp/pipe_wd4"
    pipe_rd4 = "/tmp/pipe_rd4"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd4):
        os.mkfifo(pipe_wd4)
    if not os.path.exists(pipe_rd4):
        os.mkfifo(pipe_rd4)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd4, "r") as pipe_in:
                ...
                with open(pipe_rd4, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd4):
            os.unlink(pipe_wd4)
        if os.path.exists(pipe_rd4):
            os.unlink(pipe_rd4)