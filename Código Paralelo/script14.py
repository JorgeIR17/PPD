...
#python3 script14.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd14 = "/tmp/pipe_wd14"
    pipe_rd14 = "/tmp/pipe_rd14"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd14):
        os.mkfifo(pipe_wd14)
    if not os.path.exists(pipe_rd14):
        os.mkfifo(pipe_rd14)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd14, "r") as pipe_in:
                ...
                with open(pipe_rd14, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd14):
            os.unlink(pipe_wd14)
        if os.path.exists(pipe_rd14):
            os.unlink(pipe_rd14)