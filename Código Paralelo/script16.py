...
#python3 script16.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd16 = "/tmp/pipe_wd16"
    pipe_rd16 = "/tmp/pipe_rd16"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd16):
        os.mkfifo(pipe_wd16)
    if not os.path.exists(pipe_rd16):
        os.mkfifo(pipe_rd16)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd16, "r") as pipe_in:
                ...
                with open(pipe_rd16, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd16):
            os.unlink(pipe_wd16)
        if os.path.exists(pipe_rd16):
            os.unlink(pipe_rd16)