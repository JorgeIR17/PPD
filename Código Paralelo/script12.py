...
#python3 script12.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd12 = "/tmp/pipe_wd12"
    pipe_rd12 = "/tmp/pipe_rd12"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd12):
        os.mkfifo(pipe_wd12)
    if not os.path.exists(pipe_rd12):
        os.mkfifo(pipe_rd12)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd12, "r") as pipe_in:
                ...
                with open(pipe_rd12, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd12):
            os.unlink(pipe_wd12)
        if os.path.exists(pipe_rd12):
            os.unlink(pipe_rd12)