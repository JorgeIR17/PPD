...
#python3 script2.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd2 = "/tmp/pipe_wd2"
    pipe_rd2 = "/tmp/pipe_rd2"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd2):
        os.mkfifo(pipe_wd2)
    if not os.path.exists(pipe_rd2):
        os.mkfifo(pipe_rd2)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd2, "r") as pipe_in:
                ...
                with open(pipe_rd2, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd2):
            os.unlink(pipe_wd2)
        if os.path.exists(pipe_rd2):
            os.unlink(pipe_rd2)