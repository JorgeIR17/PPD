...
#python3 script10.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd10 = "/tmp/pipe_wd10"
    pipe_rd10 = "/tmp/pipe_rd10"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd10):
        os.mkfifo(pipe_wd10)
    if not os.path.exists(pipe_rd10):
        os.mkfifo(pipe_rd10)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd10, "r") as pipe_in:
                ...
                with open(pipe_rd10, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd10):
            os.unlink(pipe_wd10)
        if os.path.exists(pipe_rd10):
            os.unlink(pipe_rd10)