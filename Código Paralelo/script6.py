...
#python3 script6.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd6 = "/tmp/pipe_wd6"
    pipe_rd6 = "/tmp/pipe_rd6"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd6):
        os.mkfifo(pipe_wd6)
    if not os.path.exists(pipe_rd6):
        os.mkfifo(pipe_rd6)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd6, "r") as pipe_in:
                ...
                with open(pipe_rd6, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd6):
            os.unlink(pipe_wd6)
        if os.path.exists(pipe_rd6):
            os.unlink(pipe_rd6)