...
#python3 script9.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd9 = "/tmp/pipe_wd9"
    pipe_rd9 = "/tmp/pipe_rd9"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd9):
        os.mkfifo(pipe_wd9)
    if not os.path.exists(pipe_rd9):
        os.mkfifo(pipe_rd9)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd9, "r") as pipe_in:
                ...
                with open(pipe_rd9, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd9):
            os.unlink(pipe_wd9)
        if os.path.exists(pipe_rd9):
            os.unlink(pipe_rd9)