...
#python3 script15.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd15 = "/tmp/pipe_wd15"
    pipe_rd15 = "/tmp/pipe_rd15"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd15):
        os.mkfifo(pipe_wd15)
    if not os.path.exists(pipe_rd15):
        os.mkfifo(pipe_rd15)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd15, "r") as pipe_in:
                ...
                with open(pipe_rd15, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd15):
            os.unlink(pipe_wd15)
        if os.path.exists(pipe_rd15):
            os.unlink(pipe_rd15)