...
#python3 script13.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd13 = "/tmp/pipe_wd13"
    pipe_rd13 = "/tmp/pipe_rd13"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd13):
        os.mkfifo(pipe_wd13)
    if not os.path.exists(pipe_rd13):
        os.mkfifo(pipe_rd13)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd13, "r") as pipe_in:
                ...
                with open(pipe_rd13, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd13):
            os.unlink(pipe_wd13)
        if os.path.exists(pipe_rd13):
            os.unlink(pipe_rd13)