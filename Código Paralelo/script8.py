...
#python3 script8.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd8 = "/tmp/pipe_wd8"
    pipe_rd8 = "/tmp/pipe_rd8"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd8):
        os.mkfifo(pipe_wd8)
    if not os.path.exists(pipe_rd8):
        os.mkfifo(pipe_rd8)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd8, "r") as pipe_in:
                ...
                with open(pipe_rd8, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd8):
            os.unlink(pipe_wd8)
        if os.path.exists(pipe_rd8):
            os.unlink(pipe_rd8)