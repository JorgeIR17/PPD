...
#python3 script3.py -3 -1 -1 2 1 1
...
if __name__ == "__main__":
    ...
    pipe_wd3 = "/tmp/pipe_wd3"
    pipe_rd3 = "/tmp/pipe_rd3"

    # Crear los pipes nombrados si no existen
    if not os.path.exists(pipe_wd3):
        os.mkfifo(pipe_wd3)
    if not os.path.exists(pipe_rd3):
        os.mkfifo(pipe_rd3)
    ...
    try:
        ...
        while True:
            ...
            with open(pipe_wd3, "r") as pipe_in:
                ...
                with open(pipe_rd3, "w") as pipe_out:
        ...
        if os.path.exists(pipe_wd3):
            os.unlink(pipe_wd3)
        if os.path.exists(pipe_rd3):
            os.unlink(pipe_rd3)