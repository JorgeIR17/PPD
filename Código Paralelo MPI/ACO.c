...
int main(int argc, char** argv) 
{
    ...
    if(fscanf(f, "%d %d", &n_hormigas1, &n_hormigas2) != 2)
    {
    ...
    if(n_hormigas1 + n_hormigas2 != NUM_HORMIGAS)
    {
    ...
    char* pipe_wd2 = "pipe_wd2";
    char* pipe_rd2 = "pipe_rd2";
